<nav class="w-full h-20 bg-primary-dark-500 flex flex-col md:flex-row justify-between sticky -top-0.5 relative z-50" id="navbar">
    ...
    <div class="w-full md:w-2/3  md:h-full hidden md:flex flex-row items-start bg-primary-dark-400 md:bg-primary-dark-500 md:justify-end" id="menu">
        ...
        @else
            <a class="px-4 grid place-items-center h-20 pb-1 hover:bg-primary-dark-300 transition" href="{{route('home')}}">
                <span class="font-semibold text-2xl text-text-light">
                    Domů
                </span>
            </a>
        ...
        @else
            <a class="px-4 grid place-items-center h-20 pb-1 hover:bg-primary-dark-300 transition" href="{{route('news')}}">
                <span class="font-semibold text-2xl text-text-light">
                    Novinky
                </span>
            </a>
        ...
        @else
            <a class="px-4 grid place-items-center h-20 pb-1 hover:bg-primary-dark-300 transition" href="{{route('magazine')}}">
                <span class="font-semibold text-2xl text-text-light">
                    Časopis
                </span>
            </a>
        ...
        @else
            <a class="px-4 grid place-items-center h-20 pb-1 hover:bg-primary-dark-300 transition" href="{{route('contact')}}">
                <span class="font-semibold text-2xl text-text-light">
                    Kontakt
                </span>
            </a>
