...
@section('content')
    <div class="" style="display: grid; place-content: center; width: 100%; height: 100vh">
        ...
        @endif
        <form method="POST" action="/register" class="card p-3 m-auto" style="width: 25rem;">
        @csrf
            ...
            <div class="flex flex-col lg:flex-row w-full items-center justify-between lg:mt-8">
                <div class="flex flex-col justify-start mx-6 w-full  mt-2">
                    ...
                    <input id="email" class="rounded-lg px-5 py-3 text-lg border border-primary-700" type="text" name="email" value="{{old('email')}}" required autofocus />
                </div>
            </div>
            ...
            <div class="flex flex-col lg:flex-row w-full items-center justify-between lg:mt-8">
                <div class="flex flex-col justify-start mx-6 w-full mt-2">
                    ...
                    <input id="password" class="rounded-lg px-5 py-3 text-lg border border-primary-700"
                           type="password"
                           name="password"
            ...
            <div class="flex flex-col lg:flex-row w-full items-center justify-between lg:mt-8">
                <div class="flex flex-col justify-start mx-6 w-full mt-2 ">
                    <label for="password_confirm" class="text-2xl mb-2">Heslo znovu:</label>
                    <input id="password_confirm" class="rounded-lg px-5 py-3 text-lg border border-primary-700"
                           type="password"
