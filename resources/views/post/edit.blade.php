...
@section('content')
    ...
    <div class="" style="display: grid; place-content: center;width: 100%; min-height: 100vh">
        ...
        <form method="POST" action="{{route('post.update', $post->id)}}" class="w-screen" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="p-3">
                ...
                <div class="p-3 flex flex-col md:flex-row">
                    ...
                    <div class="flex flex-col lg:flex-row w-full items-center justify-between lg:mt-8 m-2">
                        <div class="flex flex-col justify-start mx-6 w-full  mt-2">
                            ...
                            <input id="name" value="{{old('name') ?:$post->name}}" class="rounded-lg px-5 py-3 text-lg border border-primary-700" type="text" name="name" required autofocus />
                        </div>
                    </div>
                ...
                <div class="p-3 flex flex-col md:flex-row md:items-center">
                    ...
                    <div class="flex flex-col lg:flex-row w-full items-center justify-between lg:mt-8 m-2">
                        <div class="flex flex-col justify-start mx-6 w-full  mt-2">
                            ...
                            <input id="short" class="rounded-lg px-5 py-3 text-lg border border-primary-700" type="text" name="short" value="{{old('short') ?:$post->short}}" />
                        </div>
                    </div>
                    <div class="flex flex-col justify-start mx-6 w-full  mt-2">
